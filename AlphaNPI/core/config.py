...
encoding_dim = 256                           # dimension D of s_t
...
c_puct = 0.7                             # trade-off exploration/exploitation in mcts
...
number_of_simulations_for_validation = 20    # number of simulations used in the tree for validation (when exploit = True)