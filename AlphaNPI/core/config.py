...
reward_threshold = 0.5                    # reward threshold to increase the tasks levels in curriculum strategy

# MCTS hyper-params
number_of_simulations = 2000                 # number of simulations played before taking an action
...
alpha_replay_buffer = 0.5
beta_replay_buffer = 2.5

# Validation hyper-params
num_validation_episodes = 500                # number of episodes played for validation
